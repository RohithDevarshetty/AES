...
HD_PWD='C:/Users/SUMANTH/AES FINAL/aes.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log decryption.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source decryption.tcl -notrace
