...
HD_PWD='C:/Users/SUMANTH/AES FINAL/aes.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decryption.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decryption.tcl
